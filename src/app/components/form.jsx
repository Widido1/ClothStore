...
export default function Form() {
    return(
        <div className="h-screen" >
            ...
            <form className="container grid grid-cols-1 w-3/4 justify-self-center p-6 mx-auto my-6 h-3/4 text-center rounded-md theme1" action={async formData =>{await addProduct(formData)}}>
                <div className="container grid grid-cols-2">
                    <div className="container grid gap-8 h-3/4">
                        <div>
                            ...
                            <input id="name" placeholder="enter name" className="w-3/4 mx-auto p-2 h-8 rounded-md" required/>
                        </div>
                        <div>
                            <label className="theme1 text-2xl font-bold block" htmlFor="price">Set Price:</label>
                            <input id="price" placeholder="enter price" className="w-3/4 mx-auto p-2 h-8 rounded-md" required/>
                        </div>
                        <div>
                            <label className="theme1 text-2xl font-bold block" htmlFor="stock">Set Stock:</label>
                            <input id="stock" placeholder="stock available" className="w-3/4 mx-auto p-2 h-8 rounded-md" required/>
                        </div>
                        <div>
                            <label className="theme1 text-2xl font-bold block" id="description">Set Description:</label>
                            <textarea id="description" type="text" placeholder="Write the description here..." className="w-3/4 mx-auto p-2 h-36 rounded-md" required></textarea>
                        </div>
                    ...
                    <div className="container grid h-3/4">
                        ...
                        <textarea id="img" type="url" placeholder="Enter the link of the image here..." className="w-3/4 mx-auto h-24 p-2 rounded-md" required></textarea>
